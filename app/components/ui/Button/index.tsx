...
const variantClasses: Record<ButtonVariant, string> = {
  primary: cx(
    ...
    "dark:text-black dark:bg-green-primary-dark dark:disabled:text-neutral-400 dark:disabled:bg-neutral-600 dark:hover:bg-green-secondary-dark border border-transparent"
  ),
  secondary: cx(
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      className={cx(
        "inline-flex items-center justify-center rounded-sm transition-colors ease-linear duration-200 disabled:cursor-not-allowed prevent-select",
